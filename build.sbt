...
val gh = GitHubSettings(org = "com.example.taretmch", proj = "cats-training", publishOrg = "com.example.taretmch", license = apache2)

val mainDev =
  Developer("taretmch", "@yourhandler_without_@", "tomochuri25@gmail.com", new java.net.URL("http://github.com/yourhandler_without_@"))
...
lazy val Catstraining = project.in(file("."))
...
lazy val docs = project
  ...
  .settings(
    ...
    micrositeSettings(gh, mainDev,  "cats-training"),
    micrositeDocumentationUrl := "/cats-training/api/com.example.taretmch/index.html",
    micrositeDocumentationLabelDescription := "API Documentation",
    micrositeGithubOwner := "com.example.taretmch"
  )
lazy val buildSettings = sharedBuildSettings(gh, libs)

lazy val commonSettings = addCompilerPlugins(libs, "kind-projector") ++ sharedCommonSettings ++ scalacAllSettings ++ Seq(
  organization := "com.example.taretmch",
